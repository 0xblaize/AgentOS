...
import { sepolia, baseSepolia, bscTestnet, morphHolesky } from 'wagmi/chains'
...
// Per-chain RPC overrides (optional; public defaults used otherwise).
const RPC = {
...
export const supportedChains = [sepolia, baseSepolia, bscTestnet, morphHolesky] as const
...
export const CHAIN_ASSETS: Record<number, ChainAssets> = {
  ...
  [bscTestnet.id]: {
    ...
    usdcDecimals: 18, // some BSC testnet USDCs use 18 decimals — verify with faucet you use
